public class laptopbaru {
    ...
    public laptopbaru(String merek, String os, int ram, String processor, int slotRamKosong) {
        this.merek = merek;
        this.os = os;
        this.ram = ram;
    ...
    public static void main(String[] args) {
        laptopbaru laptop = new laptopbaru("Asus", "Windows 10", 8, "Intel Core i5",1);
